...
function login(email, password) {
    return fetch("http://ec2-43-201-20-174.ap-northeast-2.compute.amazonaws.com:8081/signin/customer", {
        method: "POST",
        headers: {
...
function validate() {
    return fetch("http://ec2-43-201-20-174.ap-northeast-2.compute.amazonaws.com:8081/checkVerify", {
        method: "GET",
        headers:
            {
                "Content_Type":
